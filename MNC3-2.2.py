...
# Definir el sistema de ecuaciones (9x9)
A_trafico = np.array([
    [3, -2, 5, -1, 4, 2, -3, 1, 2],
    [-2, 4, -3, 1, 5, -1, 2, -4, 3],
    [5, -1, 2, -3, 4, 1, -2, 3, -1],
...
b_trafico = np.array([-8, 7, -6, 5, 12, -9, 10, 3, -2], dtype=float)

# Resolver el sistema
solucion_trafico = gauss_jordan_pivot_determinante(A_trafico, b_trafico)
