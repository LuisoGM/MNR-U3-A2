...
# Definir el sistema de ecuaciones (8x8)
A_energia = np.array([
    [2, 3, -1, 4, -2, 5, -3, 1],
    [-3, 2, 4, -1, 3, -2, 5, -1],
    [4, -1, 3, 2, -3, 1, -2, 5],
...
b_energia = np.array([10, -5, 8, 4, -7, 6, -3, 9], dtype=float)

# Resolver el sistema
solucion_energia = gauss_jordan_pivot_determinante(A_energia, b_energia)
